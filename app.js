...
function randomColors() {
  ...
  colorDivs.forEach((div, index) => {
    ...
    //Add the color to the bg of each panel
...
function savePalette(e) {
  ...
  // SAve to localstorage yung palette object
  savetoLocal(paletteObj);
  saveInput.value = "";

  // Generate the palette sa library panel
  ...
  // Panggawa nung parang mini palette
